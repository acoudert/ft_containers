 ...
 * Allow compiler to know which template to use based on type
*/
...
/*
 * Is_integral definitions
 * Allow compiler to know which template to use associated to enable_if
*/
