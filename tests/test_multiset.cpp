...
void	test_canonic()
{
	...
	MULTISET<char>		cur2(cur1.begin(), it_cur);
...
void	test_iterator()
{
	...
	MULTISET<short>::iterator	it_cur = cur.begin();
	...
	MULTISET<short>::const_iterator		c_it_cur = cur.end();
	...
	MULTISET<short>::reverse_iterator		r_it_cur = cur.rbegin();
	...
	MULTISET<short>::const_reverse_iterator		c_r_it_cur = cur.rbegin();
...
{
	MULTISET<char>								cur;
	MULTISET<char>::iterator					it_cur = cur.begin();
...
void	test_erase()
{
	...
	std::cout << "Cur: | ";
	for (MULTISET<int>::iterator it = cur.begin(); it != cur.end(); it++) {
		std::cout << *it << " | ";
	}
	std::cout << std::endl;
...
void	test_swap()
{
	...
	cur2.insert('j');
	std::cout << "Cur1: | ";
	for (MULTISET<char>::iterator it = cur1.begin(); it != cur1.end(); it++) {
		std::cout << *it << " | ";
	}
	std::cout << std::endl;
	std::cout << "Cur2: | ";
	for (MULTISET<char>::iterator it = cur2.begin(); it != cur2.end(); it++) {
		std::cout << *it << " | ";
	}
	std::cout << std::endl;
...
void	test_clear()
{
	...
	cur.clear();
	std::cout << "Cur: | ";
	for (MULTISET<char>::iterator it = cur.begin(); it != cur.end(); it++) {
		std::cout << *it << " | ";
	}
	std::cout << std::endl;
...
void	test_observers()
{
	...
	MULTISET<char>		cur;
	MULTISET<char>::key_compare		k = cur.key_comp();
	MULTISET<char>::value_compare	v = cur.value_comp();
...
void	test_bound_range()
{
	...
	PAIR<MULTISET<char>::iterator, MULTISET<char>::iterator>	pa;
